-- Function: effis.current_burntareaspoly(integer)

-- DROP FUNCTION effis.current_burntareaspoly(integer);

CREATE OR REPLACE FUNCTION effis.current_burntareaspoly(IN fire_id integer)
...
END; $BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION effis.current_burntareaspoly(integer)
  OWNER TO postgres;
