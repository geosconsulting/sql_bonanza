-- Function: effis.glc_by_ba_id(integer)

-- DROP FUNCTION effis.glc_by_ba_id(integer);

CREATE OR REPLACE FUNCTION effis.glc_by_ba_id(IN fire_id integer)
...
END; $BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION effis.glc_by_ba_id(integer)
  OWNER TO postgres;
