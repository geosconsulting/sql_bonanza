-- Function: public.effis_burntarea_fireid_clc(integer)
SELECT id As area_id, 
       ST_AsText(geom),
       ST_AsText(ST_Transform(geom,3035)) as geom_proj
FROM public.burnt_area_only as b
WHERE b.id= 168888;

DROP FUNCTION public.effis_burntarea_fireid_clc(integer);

CREATE OR REPLACE FUNCTION public.effis_burntarea_fireid_clc(IN fire_id integer)
...
END; $BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION public.effis_burntarea_fireid_clc(integer)
  OWNER TO postgres;

--SELECT UpdateRasterSRID('rst','clc_1x1k','rast',3035);
--SELECT UpdateRasterSRID('rst','o_2_clc_1x1k','rast',3035);
--SELECT UpdateRasterSRID('rst','o_4_clc_1x1k','rast',3035);
--SELECT UpdateRasterSRID('rst','o_8_clc_1x1k','rast',3035);
--SELECT UpdateRasterSRID('rst','o_16_clc_1x1k','rast',3035);
--SELECT UpdateRasterSRID('rst','o_32_clc_1x1k','rast',3035);
--SELECT ST_Transform("rst"."o_32_clc_1x1k",4326);
