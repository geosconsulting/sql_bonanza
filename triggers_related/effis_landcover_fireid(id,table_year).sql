-- Function: public.effis_landcover_area(character varying)

-- DROP FUNCTION public.effis_landcover_area(character varying);

CREATE OR REPLACE FUNCTION public.effis_landcover_fire(IN fire_id integer)
...
END; $BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION public.effis_landcover_area(character varying)
  OWNER TO postgres;
