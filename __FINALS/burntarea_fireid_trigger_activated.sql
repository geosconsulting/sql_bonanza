-- Function: effis.burntarea_fireid_glc(integer)

-- DROP FUNCTION effis.burntarea_fireid_glc(integer);

CREATE OR REPLACE FUNCTION effis.burntarea_fireid_glc_trigger_activation(IN fire_id integer)
...
END; $BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION effis.burntarea_fireid_glc(integer)
  OWNER TO postgres;
