...
ALTER FUNCTION effis.hotspot_by_baid(integer, integer)
  OWNER TO postgres;
GRANT EXECUTE ON FUNCTION effis.hotspot_by_baid(integer, integer) TO public;
GRANT EXECUTE ON FUNCTION effis.hotspot_by_baid(integer, integer) TO postgres;
GRANT EXECUTE ON FUNCTION effis.hotspot_by_baid(integer, integer) TO effis_viewers;
