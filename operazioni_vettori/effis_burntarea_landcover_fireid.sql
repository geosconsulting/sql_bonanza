-- Function: public.effis_landcover_fire(integer)

-- DROP FUNCTION public.effis_landcover_fire(integer);

CREATE OR REPLACE FUNCTION public.effis_burntarea_fireid(IN fire_id integer)
...
END; $BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION public.effis_burntarea_fireid(integer)
  OWNER TO postgres;
